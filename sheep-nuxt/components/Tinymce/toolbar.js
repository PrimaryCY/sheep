...
const toolbar = [`code undo redo restoredraft | cut copy paste pastetext | forecolor backcolor bold italic underline strikethrough link anchor | alignleft aligncenter alignright alignjustify outdent indent |
    ...
    table image media charmap emoticons hr pagebreak insertdatetime print preview | fullscreen | bdmap indent2em lineheight formatpainter axupimgs toc`]
...
const reply_toolbar = [`forecolor bold italic underline link outdent
   removeformat image emoticons insertdatetime`]
