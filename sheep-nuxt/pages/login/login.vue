            ...
            <div class="form sign-in">
                ...
                <label>
                    ...
                    <input type="text"
                           ...
                           maxlength="20"
                           minlength="3"/>
                    <p v-if="loginError.email_or_phone" class="error-msg"><a href="javascript:">{{loginError.email_or_phone}}</a>
                    </p>
                </label>
                <label>
                    <span>密码</span>
            ...
            <div class="sub-cont">
                ...
                <div class="form sign-up">
                    ...
                    <label>
                        ...
                        />
                        <p v-if="registerError.username" class="error-msg"><a href="javascript:">{{registerError.username}}</a>
                        </p>
                    </label>
                    <label>
                        <span>邮箱</span>
                    ...
                    <label>
                        ...
                        />
                        <p v-if="registerError.password" class="error-msg"><a href="javascript:">{{registerError.password}}</a>
                        </p>
                    </label>
                    <label>
                        <span>重复输入密码</span>
                        <input type="password"
                               ...
                               @keyup="register_watch(3)"
                        />
                        <p v-if="registerError.verify_password" class="error-msg"><a href="javascript:">{{registerError.verify_password}}</a>
                        </p>
                    </label>
                    <button type="button" class="submit"
