tinymce.PluginManager.add('bdmap', function(editor, url) {
	...
	var iframe1 = baseURL+'/static23/bdmap/map.html';
	...
	var openDialog = function() {
		return editor.windowManager.openUrl({
			...
			onAction: function (api, details) {
				switch (details.name) {
					case 'save':
						html=''+baseURL+''+tinymceLng+''+tinymceLat+'<iframe src="/public/static23/bdmap/bd.html?center=%2C&zoom=14&width=&height=" frameborder="0" style="width:'+(bdmap_width(editor)-2)+''+(bdmap_height(editor)-2)+''+bdmap_width(editor)+'px;height:'+bdmap_height(editor)+'px;">';
